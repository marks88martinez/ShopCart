...
class SubcategoriasController extends Controller
{
    ...
    {
        $subcategorias = Categoria::WhereNotNull('categorias_id')->orderBy('id', 'DESC')->paginate(20);
    ...
    public function update(Request $request, $id)
    {
        ...
        return Redirect('admin/subcategorias')->with('success','SubCategoria Actualizado con sucesso');
    ...
    public function destroy($id)
    {
        $categoria = Categoria::find($id);
        $categoria->delete();
        return Redirect('admin/subcategorias')->with('success','banner delete con sucesso');
    }
}
