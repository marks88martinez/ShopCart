...
class CategoriasController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return Redirect('admin/categorias')->with('success','Categorias Actualizado con sucesso');
    ...
    public function destroy($id)
    {
        ...
        return Redirect('admin/categorias')->with('success','banner delete con sucesso');
    }
}
