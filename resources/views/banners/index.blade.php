                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          ...
                          @if ($banner->path_image !== null)
                                <img src="{{ $banner->path_image }}" alt="{{ $banner->name }}" style="width: 200px"></td>
                            @else
                                <img src="/imagenes/img_alt.png" alt="{{ $banner->name }}" style="width: 80px"></td>
                            @endif
                        </td>
                        ...
                        <td>
                            <a href="/admin/banners/{{ $banner->id }}/edit" class="btn btn bg-gradient-warning btn-sm"> <i class="fa fa-bell"></i>Edit</a>
