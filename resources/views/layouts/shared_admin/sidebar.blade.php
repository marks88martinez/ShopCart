<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/" class="brand-link">
      ...
      <span class="brand-text font-weight-light"><strong>MakeShop</strong></span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/admin/banners" class="nav-link {{ Request::is('banners*') ? 'active' : '' }}">
          ...
          <li class="nav-item">
            <a href="/admin/marcas" class="nav-link {{ Request::is('marcas*') ? 'active' : '' }}">
          ...
          <li class="nav-item">
            <a href="/admin/categorias" class="nav-link  {{ Request::is('categorias*') ? 'active' : '' }} ">
          ...
          <li class="nav-item ">
            <a href="/admin/subcategorias" class="nav-link {{ Request::is('subcategorias*') ? 'active' : '' }} ">
          ...
          <li class="nav-item">
            <a href="/admin/productos" class="nav-link {{ Request::is('productos*') ? 'active' : '' }}">
          ...
          <li class="nav-item">
            <a href="/admin/orders" class="nav-link {{ Request::is('orders*') ? 'active' : '' }}">
