...
<section class="thumb-section " style="margin-top: 3rem;">
    ...
    <div class="col-12 d-flex justify-content-center align-items-center scroll-x">
        <div class="btn-group mx-auto scroll-x" role="group" aria-label="Basic example">
            ...
            @endforeach
            <a href="/tratamientos"class="btn btn-light p-4">Todos</a>

        </div>
    </div>

    <div class="col-12 d-flex justify-content-center align-items-center scroll-x">
        <div class="btn-group btn-group-sm scroll-x" role="group" aria-label="Basic example">

            @foreach ($catchildren as $cats )
                @foreach ( $cats->children as $categoria)
                <a href="/categoria_prod/{{ $categoria->id}}"class="btn btn-light p-2 "  >{{ $categoria->name }}</a>
                @endforeach
            @endforeach
